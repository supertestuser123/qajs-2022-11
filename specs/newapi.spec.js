...
describe('New API Tests', () => {
  ...
  test.skip('Удаление пользователя - Негативно', async () => {
  ...
  test.skip('Получение информации о пользователе', async () => {
  ...
  test.skip('Получение информации о пользователе c невалидным токенном (ошибка авторизации)', async () => {
 ...
 test.skip('Получение информации о пользователе c (ошибка авторизации)', async () => {
  const token = await getToken({ username: config.user.userName, password: config.user.password })
